...
@Component({
  selector: 'app-feedback-question-1',
  templateUrl: './feedback-question-1.component.html',
  styleUrls: ['./feedback-question-1.component.css']
})
export class FeedbackQuestion1Component implements OnInit, AfterViewInit {
    ...
    this.chart = new Chart(ctx, {
      ...
      options: {
        ...
        plugins: {
          title: {
            display: true,
            text: `Question 1: ${data.question}`,  // Using the question text from the backend response
            font: {
              size: 18
            },
            position: 'bottom',
