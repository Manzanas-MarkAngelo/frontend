...
@Component({
  selector: 'app-feedback-question-10',
  templateUrl: './feedback-question-10.component.html',
  styleUrls: ['./feedback-question-10.component.css']
})
export class FeedbackQuestion10Component implements OnInit, AfterViewInit {
  @ViewChild('pieChart', { static: false }) private chartRef!: ElementRef;
  public chart: any;
  private questionNumber = 10;
